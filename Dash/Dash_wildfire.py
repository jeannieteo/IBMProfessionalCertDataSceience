...
#outer division starts
     html.Div([
                ...
                html.Div([
                    html.H2('Region', style={'margin-right': '2em'}),
                    #Radio items to select the region
                    dcc.RadioItems(df['Region'].unique(), value ='NSW', id='region_input',inline=True)]),
                    #Dropdown to select year
                html.Div([
                    html.H2('Select Year:', style={'margin-right': '2em'}),
                    dcc.Dropdown(df.Year.unique(), value = 2005,id='year_input')]),
